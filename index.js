...
memberlimit = 2
name = "HIRZAN"
rdaftar = "Follow Ig : @boba.designer"
rmenu = "Follow Ig : @boba.designer"
botinfo = "HIRZAN"
fake = 'YDBOT-FIX-ANTIDELETE'
ator = 'FOLLOW'
namo = 'boba.designer*'
cr = "~*Follow Ig : @boba.designer🍁~OWNER:Hirzan🍁*"

/******** OWNER NUMBER**********/
const ownerNumber = ["6285860881269@s.whatsapp.net"] //NOMOR LUH
const premium = ["6285860881269@s.whatsapp.net"]
/************************************/
...
case 'notoxic':
				...
				case 'bc':
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							MrG.sendMessage(_.jid, buff, image, {caption: `*「 BOBA BOT 」*\n\n${body.slice(4)}`})
						}
						reply('')
					} else {
						for (let _ of anu) {
							sendMess(_.jid, `*「 BOBA BOT 」*\n\n${body.slice(4)}`)
						}
						reply('*「 SUKSES BOSKU 」*')
					}
					break
